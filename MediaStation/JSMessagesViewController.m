...
- (void)setup
{
    ...
    CGFloat inputViewHeight = (inputViewStyle == JSMessageInputViewStyleFlat) ? 95.0f : 40.0f;
   ...
   // tableView.backgroundView = [[UIImageView alloc] initWithImage:
...
- (void)keyboardWillShowHide:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:duration
                     ...
                     animations:^{
                         CGFloat keyboardY = [self.view convertRect:keyboardRect fromView:nil].origin.y+50;
