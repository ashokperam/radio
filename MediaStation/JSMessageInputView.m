...
- (void)configureInputBarWithStyle:(JSMessageInputViewStyle)style
{
    ...
    if (style == JSMessageInputViewStyleClassic) {
        ...
        self.image = [[UIImage imageNamed:@"inputv-bar-background"] resizableImageWithCapInsets:UIEdgeInsetsMake(19.0f, 3.0f, 19.0f, 3.0f)
        ...
        inputFieldBack.image = [[UIImage imageNamed:@"inputv-field-cover"] resizableImageWithCapInsets:UIEdgeInsetsMake(20.0f, 12.0f, 18.0f, 18.0f)];
        inputFieldBack.autoresizingMask = (UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight);
        inputFieldBack.backgroundColor = [UIColor grayColor];
        [self addSubview:inputFieldBack];
    }
    else {
        _textView.frame = CGRectMake(4.0f, 4.5f, width, height);
        _textView.backgroundColor = [UIColor clearColor];
        _textView.layer.borderColor = [UIColor colorWithWhite:0.3f alpha:1.0f].CGColor;
...
- (void)configureSendButtonWithStyle:(JSMessageInputViewStyle)style
{
    ...
    if (style == JSMessageInputViewStyleClassic) {
        ...
        [sendButton setTitleColor:[UIColor clearColor] forState:UIControlStateNormal];
