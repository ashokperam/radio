...
- (void)viewDidLoad
{
  ...
  //  self.tableView.backgroundView = [[UIImageView alloc] initWithImage:    /// set background tableview
    ...
    [APIDownload downloadWithURL:self.urlString delegate:self];
...
-(IBAction)customCellOff:(id)sender{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
       ...
       // cell.imageCustom.layer.cornerRadius = 27; // 160 is just a guess
      //  cell.imageCustom.clipsToBounds = YES;
       // cell.imageCustom.layer.borderColor = [UIColor colorWithRed:0.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:0.6].CGColor;
       // cell.imageCustom.layer.borderWidth = 4.0f;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"Player" sender:indexPath];
     NSLog(@"tap");
...
{
  //  UIImage *patternImage = [UIImage imageNamed:@"back2.jpg"];
