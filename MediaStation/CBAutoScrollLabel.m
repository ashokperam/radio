...
- (void)refreshLabels
{
   ...
   // CGSize labelSize = [self.mainLabel.text sizeWithFont:self.mainLabel.font
    ...
    [[NSAttributedString alloc]
     initWithString:self.mainLabel.text
     attributes:@
     {
     NSFontAttributeName: self.mainLabel.font
     }];
    CGRect rect = [attributedText boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, CGRectGetHeight(self.bounds))
